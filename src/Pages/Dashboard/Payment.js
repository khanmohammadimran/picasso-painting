...
const stripePromise = loadStripe(
  "pk_test_51L46PaFyeVpk0BaQiWFqMsZA8WtDVRNMQuihQ3RaV2BorgaoawaMWPvsMEexzYvs6iD0kFxwMsULoU8ZWAaYOLvw005InoKC0d"
);
...
const Payment = () => {
  ...
  const { data: payment, isLoading } = useQuery(["mypurchase", id], () =>
    fetch(url, {
      method: "GET",
      headers: {
