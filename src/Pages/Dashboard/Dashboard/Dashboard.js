    ...
    return (
        <div className="drawer drawer-mobile">
            ...
            <div className="drawer-content text-center">
                <h2 className="btn btn-ghost normal-case text-4xl font-josefin text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600 py-8">Welcome to your Dashboard</h2>
                <Outlet></Outlet>
            </div>
            <div className="drawer-side text-slate-600 text-xl font-raleway">
                ...
                <ul className="menu p-4 overflow-y-auto w-64 bg-base-100 text-base-content">
                    ...
                    {admin && <li><Link to="/dashboard/alluser">Make Admin</Link></li>}
