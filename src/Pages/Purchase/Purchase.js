        ...
        <div className="hero-content flex-col lg:flex-row">
          ...
          <div>
            <h2 className="text-xl pb-2">
              <strong>See The Detail about the Tool</strong>
            </h2>
            <h2 className="text-xl pb-2">
              <strong>Tool Name:</strong> {tools.name}
            </h2>
            <p>
      ...
      <div className="bg-white w-1/2 mx-auto shadow-lg rounded-lg p-8">
        <form onSubmit={handleSubmit}>
          ...
          <div className="form-control">
            ...
            <input
              value={tools?.minimumOrderQuantity}
              className="input input-bordered"
            />
          </div>
          <div className="form-control">
          ...
          <input
            className="btn btn-ghost border-0 font-sans text-white w-full bg-gradient-to-r from-purple-400 to-pink-600"
            type="submit"
            value="Purchase"
          />
        </form>
