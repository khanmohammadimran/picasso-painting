...
const Blogs = () => {
    return (
        <div className='bg-white'>
            ...
            <div className="card bg-base-100 font-raleway h-screen">
                <div className="card-body w-1/2 mx-auto">
                    <div className="collapse collapse-plus border border-base-300 bg-base-100 rounded-box text-white">
                        <input type="checkbox" className="peer" />
                        <div className="collapse-title bg-primary bg-gradient-to-r from-purple-400 to-pink-600">
