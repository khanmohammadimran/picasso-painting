...
const MyPortfolio = () => {
    return (
        <div>
            <div class="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0 font-raleway">
                ...
                <div id="profile"
                    ...
                    <div class="p-4 md:p-12 text-center lg:text-left">
                        ...
                        <h1 class="text-3xl font-bold pt-8 lg:pt-0">Khan Mohammad Imran</h1>
                        <div class="mx-auto lg:mx-0 w-4/5 pt-3 border-b-2 border-green-500 opacity-25"></div>
                        <p class="pt-4 text-base font-bold flex items-center justify-center lg:justify-start"><svg
                            class="h-4 fill-current text-green-700 pr-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                            <path
                        ...
                        <p class="pt-8 text-sm font-raleway"> <strong>Expertise:</strong> JavaScript, ES6, React, React Router, React Hook, Firebase (Authentication), HTML5,
                        ...
                        <div class="pt-12">
                            <h2 class="bg-gradient-to-r from-purple-400 to-pink-600 text-white text-center font-bold py-2 px-4 rounded-lg">
                                My Projects
                            </h2>
                        </div>

                        <div class="mt-6 pb-16 lg:pb-0 w-4/5 lg:w-full mx-auto flex flex-wrap items-center justify-center">
                            <a class="link" href="https://hiking-equipment-outdoor-gear.web.app/" data-tippy-content="@facebook_handle"><svg
                            ...
                            <a class="link" href="https://dancing-alpaca-52c555.netlify.app/" data-tippy-content="@facebook_handle"><svg
                                class="h-6 fill-current text-gray-600 hover:text-green-700" role="img" viewBox="0 0 24 24"
                                xmlns="http://www.w3.org/2000/svg">
