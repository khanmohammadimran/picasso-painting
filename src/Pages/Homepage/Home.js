    ...
    <div>
      ...
      <div className="bg-white">
        <div className="text-center py-8">
          <h2 className="btn btn-ghost normal-case text-4xl font-josefin text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600">
            Picasso Painting
          </h2>
        </div>
        <div className="grid lg:grid-cols-3 gap-8">
          {tools
            ...
            .map((tool) => (
              <div
                key={tool._id}
                className="card mx-auto bg-base-100 shadow-xl border-2"
              >
                <figure>
        ...
        <div className="text-center py-8">
          <h2 className="font-bold normal-case text-4xl font-josefin text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600">
            Business Summary
          </h2>
        </div>
        <div className="stats stats-vertical lg:stats-horizontal shadow grid justify-center lg:justify-evenly">
          <div className="stat">
            <div className="stat-title font-bold text-xl font-josefin text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600">
              Customers
            </div>
        ...
        <div className="text-center pt-16">
          ...
          <p className="mb-8 mt-4 text-xl font-raleway">
